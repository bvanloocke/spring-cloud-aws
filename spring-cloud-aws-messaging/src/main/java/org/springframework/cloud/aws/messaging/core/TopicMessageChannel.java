...
package net.persgroep.service.publishing.service.infrastructure.config;
...
/**
 * copy paste of TopicMessageChannel
 * <p>
 * fixes Numeric Types
 */
public class CorrectedTopicMessageChannel extends AbstractMessageChannel {
